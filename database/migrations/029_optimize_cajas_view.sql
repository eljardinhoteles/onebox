-- =============================================================================
-- Migración 029: Optimización de Vista de Balances
-- Refactoriza v_cajas_con_saldo para usar agregación única
-- Mejorando drásticamente el rendimiento en empresas con muchas transacciones.
-- =============================================================================
